# Contributing to FeiControl

Thank you for your interest in contributing! 🦞

FeiControl is an open-source dashboard for OpenClaw AI agent instances. Contributions of all kinds are welcome — bug fixes, new features, documentation improvements, and accessibility enhancements.

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR-USERNAME/feicontrol.git`
...
# Edit .env.local with your config — all personal values go here
npm run dev
```
...
**❌ Bad:**
```typescript
const username = "@your-twitter-handle";
```
...
1. **Update documentation**
   - Update README.md if adding features or configuration options
